...
# 云盘源文件挂载本地后 挂载进媒体服务器的根路径，与上方对应   /cloud/CloudDrive/aliyun/emby/tvshow/爸爸去哪儿/Season 5/14.特别版.mp4
library_path = "/cloud/CloudDrive"
...
for f in files:
    ...
    try:
        with open(f, 'r') as file:
            content = file.read()
            # 获取扩展名
            library_file = str(library_file).replace(library_path, "")
            # 对盘符之后的所有内容进行url转码
